...
import type { PluginParameter, ModelInfo } from "../../api/client";
...
interface LoraListFieldProps {
  itemSchema: Record<string, PluginParameter>;
  value: LoraItem[];
  onChange: (value: LoraItem[]) => void;
}

export const LoraListField = ({
  itemSchema,
  value,
  onChange,
}: LoraListFieldProps) => {
  ...
  return (
    <div className="lora-list-field">
      <div className="lora-list-header">
        <span className="lora-list-label">LoRA Models</span>
        <button
          type="button"
              ...
              <div className="lora-item-fields-row">
                ...
                <div className="lora-field-strength">
                  <input
                    ...
                    max="2"
                    step="0.01"
                    value={lora.strength_clip.toFixed(2)}
                    onChange={(e) =>
                      handleChange(
                        index,
                        "strength_clip",
